...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 07 jan. 2019 à 16:12
...
(2, 2, '0'),
(5, 1, 'sdd'),
(6, 1, '111 rue de la fontaine sarrazin'),
(7, 1, '111 rue de la fontaine sarrazin'),
(8, 6, 'yaya'),
(9, 6, 'Nancy');
...
--
ALTER TABLE `house`
  MODIFY `idHouse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
